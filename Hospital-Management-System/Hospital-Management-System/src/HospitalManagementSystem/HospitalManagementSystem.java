...
public class HospitalManagementSystem {
    ...
    private static final String password = "s@1209s@1209";
    ...
    private static boolean checkDoctorAvailability(int Doctor_Id, int Appointment_Date, Connection connection) {
